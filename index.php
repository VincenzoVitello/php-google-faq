...
<body>
    ...
    <div class="logo">
        <img src="google-privacy-logo.png" alt="">
    </div>
    ...
    <?php 
        $faqArray = [ // array Google Privacy FAQ strutturato in domande e risposte, in un caso è presente anche una sotto domanda con relativa risposta. 
                    // 
            [
            ...
            [
                ...
                Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a>Centro Google</a> per la sicurezza online.
